...
docsToPlot <- tm_map(docs6, tolower)
...
plotWordFrequency(docsToPlot, "Most frequent words total")
```
```{r echo=FALSE, fig.cap="6.2 Words Frequency ohne Stopwords", fig.align="center"}
docsToPlot <- tm_map(docsToPlot, removeWords, c(stopwords("english"),"160","wikipedia", "gallen", "edit", "dated",
                                      "articles", "st160gallen", "swiss", "containing", "2009", "one", "accessed"))

d<-plotWordFrequency(docsToPlot, "Most frequent words removed Stopwords")
...
### Bigram
```{r}
#falls ich das nicht machen moechte, RWeka package und sys.setenv entfernen
