...
# d<-plotWordFrequency(sgzh_clean, "Most frequent words removed Stopwords")

# sgzh_clean<-gsub("â", "x", sgzh_clean)
# sgzh_clean<-gsub("€", "x", sgzh_clean)
# sgzh_clean<-gsub("œ", "x", sgzh_clean)
