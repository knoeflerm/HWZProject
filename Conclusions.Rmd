...
plotWordFrequency(docs7, "Most frequent words total")
```
```{r echo=FALSE, fig.cap="6.2 Words Frequency ohne Stopwords", fig.align="center"}
docs7 <- tm_map(docs7, removeWords, c(stopwords("english"),"160","wikipedia", "gallen", "edit", "dated",
                                      "articles", "st160gallen", "swiss", "containing", "2009", "one", "accessed"))

plotWordFrequency(docs7, "Most frequent words removed Stopwords")
