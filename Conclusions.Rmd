...
#https://rstudio-pubs-static.s3.amazonaws.com/123908_3df6d25c8ad04030a2a429661125a59b.html#/16
...
titanic3
dataDecisionTree <- c("training", "test") %>%
  sample(nrow(titanic3), replace = T) %>%
  split(titanic3, .)

rtree_fit <- rpart(survived ~ ., dataDecisionTree$training) 
plot(rtree_fit, uniform=TRUE, main="Classification Tree f?r Kaufentscheid")
